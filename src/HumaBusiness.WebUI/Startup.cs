...
using HumaBusiness.WebUI.Data;
using HumaBusiness.WebUI.Models;

namespace HumaBusiness.WebUI
{
    ...
    public class ApplicationSettings
    {
        ...
        public string User { get; set; } = "Carlos Augusto";
        public string Email { get; set; } = "carlos@humasoftware.com.br";
